...
export const list = [
  {
    title: `Technology and education are my concerns of life`,
    subs: [
      {
        title: `Hi, I'm a software developer`,
        message: `After graduating master degree, I've been working as a software developer, especially in web.
My motivation is based on the desire to accomplish more with less skill. Do you use JavaScript? It really fits me. It not only build web apps but also desktop apps and mobile apps in wide categories.
My skill stacks are fixed by React and Expo(React Native) recently. `,
  ...
  {
    title: `Throw away your rotten pride!`,
    subs: [
      {
        title: `We should learn from others`,
        message: `New technologies and talented younger people appear in front of you suddenly. What attitude will you take in such a case?
As you age, we become more experienced, for better or worse. It is difficult to accept unknown things sometimes because of our stale experiences. Don't be afraid to learn from the unknown. We have to evolve step by step in life.`,
      },
    ],
  },
  {
